...
% 1. Set batsize to be divisor of total no. of samples = 670
% 2. Set the train path
%%
...
trainPath = '/home/user/Documents/Ashish/dataStores/dataREP1000.mat';
...
save('/home/user/Documents/Ashish/models/Files1000REP/min_maxREP.mat','min_max_store');
...
%    nnFWD = nnFeedForward(nn, train_x);
 nn = nntrainREP(nn, train_x, train_y, opts);
...
utts = 1000;
str1 = ['/home/user/Documents/Ashish/models/Files1000REP/wavEpochREP' num2str(utts) '.wavdata'];
save(str1,'resultOut');